...
- **`docs/tasks/` に P8 の task ファイルは意図的に存在しない。** `docs/tasks/` は P0〜P7 の 137 件＋後から起票した P1-24（客室タイプ管理）の 138 件。P8 の 9 項目は `docs/PROGRESS.md` にチェックボックスだけを置いてあり、GA 判定通過後に task 化する。**GA 判定前に P8 の task ファイルを作成しないこと。**
