...
describe("ENTITY_PREFIXES", () => {
  it("仕様書由来の 11 個と P0-06 の 13 個・P0-08 の 1 個・P1-01 の 7 個・P2-01 の 4 個・P4-01 の 5 個・P5-01 の 6 個・P5-07 の 1 個・P5-12 の 1 個・P5-14 の 1 個・P5-18 の 4 個・P8-02/03 の 2 個を持つ", () => {
    ...
    expect([...ENTITY_PREFIXES]).toEqual([
      ...
      "arst",
      "arow",
      // P5-18。支払集計（docs/PK-SPEC-PAY.md §1）。
      "sppf",
      "payr",
      "pout",
      "poln",
