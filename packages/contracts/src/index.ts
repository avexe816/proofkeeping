...
// **宿泊者の情報を受け取る欄が無い**（security.md §3。取引先は事業者）。
// **削除の口も、料金設定を書き換える口も無い**（値上げは行の追加）。
export {
  COUNTERPARTY_ADDRESS_MAX_LENGTH,
  COUNTERPARTY_CODE_MAX_LENGTH,
  COUNTERPARTY_ERROR_CODES,
  COUNTERPARTY_NAME_MAX_LENGTH,
  INVOICE_ITEM_CODES,
  MAX_CC_EMAILS,
  MAX_UNIT_PRICE,
  closingDaySchema,
  counterpartyErrorSchema,
  counterpartyListResponseSchema,
  counterpartySchema,
  counterpartyUpsertRequestSchema,
  counterpartyUpsertResponseSchema,
  invoiceItemCodeSchema,
  invoiceRegistrationNoSchema,
  paymentTermDaysSchema,
  pricingRuleCloseRequestSchema,
  pricingRuleCreateRequestSchema,
  pricingRuleCreateResponseSchema,
  pricingRuleListResponseSchema,
  pricingRuleSchema,
  taxRateSchema,
  taxRoundingModeSchema,
  type CounterpartyError,
  type CounterpartyErrorCode,
  type CounterpartyListResponse,
  type CounterpartySummary,
  type CounterpartyUpsertRequest,
  type CounterpartyUpsertResponse,
  type InvoiceItemCodeValue,
  type PricingRuleCloseRequest,
