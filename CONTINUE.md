...
## 最終状態
- main HEAD: P7-03 の PR（`claude/continue-z1xuml`）
- 完了: 125 task
- 次: **P7-02（ログイン案内カード PDF）。** ただし QR の判断が先
...
1. **下の「P7-02 に着手する前に」を読む。** QR コードの生成手段が無い。
2. `docs/tasks/P7-02.md` と `docs/PK-SPEC-P7.md` §2.4 を読む。
